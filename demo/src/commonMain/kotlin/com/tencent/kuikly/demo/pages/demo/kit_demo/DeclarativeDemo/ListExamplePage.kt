...
internal class ListExampleModel(
    val title: String = "",
    val color: Color = Color.TRANSPARENT,
)

@Page("ListExamplePage")
internal class ListExamplePage: BasePager() {
    private var listedModels by observableList<ListExampleModel>()
